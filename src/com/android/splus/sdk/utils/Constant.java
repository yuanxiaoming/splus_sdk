...
public class Constant {
    ...
    public static final String STATISTICS_SERVER_URL = "http://sy.api.37wan.cn/sdk/ext/enter_server.php";

    public static final String STATISTICS_ROLE_URL = "http://sy.api.37wan.cn/sdk/ext/enter_role.php";

    public static final String STATISTICS_LEVEL_URL = "http://sy.api.37wan.cn/sdk/ext/enter_level.php";

    public static final String STATISTICS_ONLINETIME_URL = "http://sy.api.37wan.cn/sdk/ext/enter_onlinetime.php";

    public static final String LRQ_WAPPAY_URL = "http://sy.api.37wan.cn/sdk/wappay/sxdalipayapi.php";

    public static final String ACTIONSTATIC_URL = "http://sy.api.37wan.cn/sdk/listen/pay.php";

 //   public static final String HTMLWAPPAY_URL = "http://sy.api.37wan.cn/htmlWapPay/payIndex.php";

    public static final String HTMLWAPPAY_URL = "http://sy.api.37wan.cn/htmlWapPay_test/payIndex.php";

    public static final String RECHARGE_BY_QUATO = "3";
