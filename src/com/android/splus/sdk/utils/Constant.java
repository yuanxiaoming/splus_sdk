...
public class Constant {
    ...
    public static final String URL = "http://api.splusgame.com/";

    public static final String ACTIVE_URL = URL + "sdk/active.php";

    public static final String LOGIN_URL = URL + "sdk/login.php";
