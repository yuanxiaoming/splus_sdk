...
public class AnnouncementsPage extends LinearLayout {
    ...
    public AnnouncementsPage(Activity activity, String deviceno, Integer gameid, String partner, String referer, Integer uid, String passport, String password,Integer serverId, Integer roleId, String roleName, String serverName,String appkey) {
        ...
        System.out.println(NetHttpUtil.hashMapTOgetParams(mSqModel, Constant.ANNOUNCEMENTSPAGE_URL));
        mCustomWebView.postUrl(Constant.ANNOUNCEMENTSPAGE_URL, EncodingUtils.getBytes(data, "UTF-8"));
