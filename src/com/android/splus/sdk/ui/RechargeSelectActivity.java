...
public class RechargeSelectActivity extends BaseActivity {
    ...
    private void goBack() {
        ...
        if (RechargeAlipayHtmlPage.class.getName().equals(mCurrentPage) && mRechargeAlipayHtmlPage != null) {
        ...
        if ((RechargeAlipayPage.class.getName().equals(mCurrentPage) && mRechargeAlipayPage != null) || (RechargeAlipayQuotaPage.class.getName().equals(mCurrentPage) && mRechargeAlipayQuotaPage != null)) {
    ...
    private void addView(View v, String tag) {
        ...
        vf_recharge_center.addView(v, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
        mCurrentPage = tag;
        showNextPage();
    }
            ...
            switch (rechargeTypeModel.getRechargeType()) {
                case Constant.ALIPAY_FAST:
                    ...
                    if (mType == Constant.RECHARGE_BY_NO_QUATO) {
                        // 进入支付宝快捷页面
                        mRechargeAlipayPage = new RechargeAlipayPage(getUserData(), mActivity, getDeviceno(), mSplusPayManager.getAppkey(), mSplusPayManager.getGameid(), mSplusPayManager.getPartner(), mSplusPayManager.getReferer(), mSplusPayManager.getServerId(),
                                        mSplusPayManager.getRoleId(), mSplusPayManager.getRoleName(), mSplusPayManager.getServerName(), mSplusPayManager.getOutorderid(), mSplusPayManager.getPext(), mType, mPayway, mOrientation);
                        ...
                        mRechargeAlipayQuotaPage = new RechargeAlipayQuotaPage(getUserData(), mActivity, getDeviceno(), mSplusPayManager.getAppkey(), mSplusPayManager.getGameid(), mSplusPayManager.getPartner(), mSplusPayManager.getReferer(), mSplusPayManager.getServerId(),
                                        mSplusPayManager.getRoleId(), mSplusPayManager.getRoleName(), mSplusPayManager.getServerName(), mSplusPayManager.getOutorderid(), mSplusPayManager.getPext(), mType, mPayway, mMoney);
                ...
                case Constant.UNION_PAY:
                    ...
                    // 进入银联页面
                    if (mType == Constant.RECHARGE_BY_NO_QUATO) {
                        mRechargeUnionPayPage = new RechargeUnionPayPage(getUserData(), mActivity, getDeviceno(), mSplusPayManager.getAppkey(), mSplusPayManager.getGameid(), mSplusPayManager.getPartner(), mSplusPayManager.getReferer(), mSplusPayManager.getServerId(),
                                        mSplusPayManager.getRoleId(), mSplusPayManager.getRoleName(), mSplusPayManager.getServerName(), mSplusPayManager.getOutorderid(), mSplusPayManager.getPext(), mType, mPayway, mOrientation);
                        addView(mRechargeUnionPayPage, RechargeUnionPayPage.class.getName());
                    } else if (mType == Constant.RECHARGE_BY_QUATO) {
                        mRechargeUnionQuotaPayPage = new RechargeUnionQuotaPayPage(getUserData(), mActivity, getDeviceno(), mSplusPayManager.getAppkey(), mSplusPayManager.getGameid(), mSplusPayManager.getPartner(), mSplusPayManager.getReferer(), mSplusPayManager.getServerId(),
                                        mSplusPayManager.getRoleId(), mSplusPayManager.getRoleName(), mSplusPayManager.getServerName(), mSplusPayManager.getOutorderid(), mSplusPayManager.getPext(), mType, mPayway, mMoney);
                        addView(mRechargeUnionQuotaPayPage, RechargeUnionQuotaPayPage.class.getName());
                    }
                    break;
                case Constant.CHAIN_CMM:
                    recharge_titlr_middle_text.setText("移动卡");
                    // 进入移动卡页面
                    if (mType == Constant.RECHARGE_BY_NO_QUATO) {
                        mRechargeCardPage = new RechargeCardPage(getUserData(), mActivity, getDeviceno(), mSplusPayManager.getAppkey(), mSplusPayManager.getGameid(), mSplusPayManager.getPartner(), mSplusPayManager.getReferer(), mSplusPayManager.getServerId(),
                                        mSplusPayManager.getRoleId(), mSplusPayManager.getRoleName(), mSplusPayManager.getServerName(), mSplusPayManager.getOutorderid(), mSplusPayManager.getPext(), mType, mPayway, mOrientation);
                        addView(mRechargeCardPage, RechargeCardPage.class.getName());
                    } else if (mType == Constant.RECHARGE_BY_QUATO) {
                        mRechargeCardQuotaPage = new RechargeCardQuotaPage(getUserData(), mActivity, getDeviceno(), mSplusPayManager.getAppkey(), mSplusPayManager.getGameid(), mSplusPayManager.getPartner(), mSplusPayManager.getReferer(), mSplusPayManager.getServerId(),
                                        mSplusPayManager.getRoleId(), mSplusPayManager.getRoleName(), mSplusPayManager.getServerName(), mSplusPayManager.getOutorderid(), mSplusPayManager.getPext(), mType, mPayway, mMoney);
                ...
                case Constant.PERSON:
                    recharge_titlr_middle_text.setText("人工充值");
                    mRechargePersonPage = new RechargePersonPage(getUserData(), mActivity, getDeviceno(), mSplusPayManager.getAppkey(), mSplusPayManager.getGameid(), mSplusPayManager.getPartner(), mSplusPayManager.getReferer(), mSplusPayManager.getServerId(),
                                    mSplusPayManager.getRoleId(), mSplusPayManager.getRoleName(), mSplusPayManager.getServerName(), mSplusPayManager.getOutorderid(), mSplusPayManager.getPext(), mType, mPayway, mOrientation);
    ...
    private AlipayHtmlClick mAlipayHtmlClick = new AlipayHtmlClick() {
        ...
        public void onAlipayHtmlClick(UserModel userModel, Activity activity, String deviceno, String appKey, Integer gamid, String partner, String referer, Integer serverId, Integer roleId, String roleName, String serverName, String outOrderid, String pext, Integer type,
            ...
            mRechargeAlipayHtmlPage = new RechargeAlipayHtmlPage(userModel, activity, deviceno, appKey, gamid, partner, referer, serverId, roleId, roleName, serverName, outOrderid, pext, type, payway, renminbi);
