...
public class RechargePersonPage extends LinearLayout {
    ...
    private String[] BANK_DATA_NAME = {
                    "工商银行", "招商银行", "建设银行", "农行银行"
    };

    private String[] BANK_DATA_NAME_TIPS = {
                    "开户地:广州 \n开户行:工商银行广州工业园支行 \n帐户:灿和网络科技有限公司 \n卡号:44001 47051 30530 06982", "开户地:广州 \n开户行:招商银行广州工业园支行 \n帐户:灿和网络科技有限公司 \n卡号:44001 47051 30530 06982", "开户地:广州 \n开户行:建设银行广州工业园支行 \n帐户:灿和网络科技有限公司 \n卡号:44001 47051 30530 06982",
                    "开户地:广州 \n开户行:农行银行广州工业园支行 \n帐户:灿和网络科技有限公司 \n卡号:44001 47051 30530 06982"
    };
    ...
    public RechargePersonPage(UserModel userModel, Activity activity, String deviceno, String appKey, Integer gameid, String partner, String referer, Integer serverId, Integer roleId, String roleName, String serverName, String outOrderid, String pext, Integer type,
        ...
        inflate(activity, ResourceUtil.getLayoutId(activity, KR.layout.splus_recharge_person_layout), this);
        findViews();
        initViews();
        setlistener();
        processLogic();
    ...
    private void findViews() {
        recharge_person_tips = (TextView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_person_tips));
        recharge_person_tips.setText(Html.fromHtml("<font color=#FE8E35>请选择对应的开户行</font>"));
        recharge_person_bank_tips = (TextView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_person_bank_tips));
        recharge_person_bank_tips.setPadding(0, 0, 0, 0);
        recharge_person_bank_tips.setText(BANK_DATA_NAME_TIPS[0]);
        recharge_persontel_tips = (TextView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_persontel_tips));
        recharge_persontel_tips.setText(KR.string.splus_recharge_persontel_tips);
        recharge_personqq_tips = (TextView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_personqq_tips));
        recharge_personqq_tips.setText(KR.string.splus_recharge_personqq_tips);

        recharge_personweixin_tips = (TextView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_personweixin_tips));
        recharge_personweixin_tips.setText(KR.string.splus_recharge_personweixin_tips);

        recharge_person_gridview_select = (CustomGridView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_person_gridview_select));

        recharge_card_explian_ibtn = (ImageButton) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_card_explian_ibtn));

        recharge_person_explian_tips = (TextView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_person_explian_tips));
        recharge_person_explian_tips.setText(Html.fromHtml(KR.string.splus_recharge_person_explian_tips));

        recharge_person_explian_scrollview = (ScrollView) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_person_explian_scrollview));

        recharge_person_explian_scrollview.setVisibility(View.GONE);

        recharge_person_linearlayout = (LinearLayout) findViewById(ResourceUtil.getId(mActivity, KR.id.splus_recharge_person_linearlayout));
     ...
     * @author xiaoming.yuan
     * @data 2014-3-13 下午5:36:14 void 返回类型
     */
